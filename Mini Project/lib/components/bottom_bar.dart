...
import 'package:soal1/screens/Profile.dart';
import 'package:soal1/screens/homepage.dart';
import 'package:soal1/screens/about.dart';
    ...
    return Scaffold(
      body: PageView(
        ...
        children: [
          ...
          Container(child: NewsDetailScreen()),
